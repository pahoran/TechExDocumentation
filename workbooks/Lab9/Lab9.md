...
<!-- ![$analytics banner](images/Lab9-01-analytics-banner.png =600x) -->
<img src="images/Lab9-01-analytics-banner.png" width="600"/>

Then press the ‘Create Chart’ button

<!-- ![$create chart](images/Lab9-02-create-chart.png =750x) -->
...
<!-- ![$general settings](images/Lab9-03-general-settings.png =600x) -->
...
<!-- ![$chart definition](images/Lab9-04-chart-definition.png =650x) -->
...
<!-- ![$custom charts](images/Lab9-05-custom-charts.png =750x) -->
